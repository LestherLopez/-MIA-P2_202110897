...
def login_command(user_login, pass_login, id_option, list_mount, sesion_activa, list_users, usuario_registrado):
    ...
    if find:
        ...
        print(f"ERROR: Particion {id_option} no encontrado en las particiones montadas, por lo que no es posible ejecutar mkfs.")
    ...
    if sesion_activa:
        ...
        estado.mensaje = "¡Inicio de sesion exitoso!"
        ...
        estado.mensaje = "ERROR: Las credenciales ingresadas son incorrectas"
        return sesion_activa