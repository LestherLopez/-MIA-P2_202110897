...
def p_command_mkdisk(t):
   ...
   # command_mkdisk_(t[1])
    if(size_option == None ):
        print("El parametro size es obligatorio")
    elif(path_option==None):
        print("El parametro path es obligatorio")
    else:
...
def p_command_fdisk(t):
    ...
    if(path_option==None):
        ...
        print("El parametro name es obligatorio")
    else:
        path_option_wc = remove_comillas(path_option)
...
def p_command_mkfs(t):
    ...
    if(id_mkfs==None):
        print("El parametro id es obligatorio para ejecutar el comando MKFS")
    else:
...
def p_command_login(t):
    ...
    if(user_login==None):
        print("El parametro user es obligatorio para ejecutar el comando LOGIN")
    
    elif(pass_login==None):
        print("El parametro pass es obligatorio para ejecutar el comando LOGIN")
    elif(id_login==None):
        print("El parametro id es obligatorio para ejecutar el comando LOGIN")
    else:
...
def p_command_mkfile(t):
    ...
    if(path_mkfile==None):
        print("El parametro path es obligatorio para el comando mkfile")
    else:
...
def p_command_mkdir(t):
    ...
    if(path_mkdir==None):
        print("El parametro path es obligatorio para el comando mkdir")
    else:
...
def p_command_rep(t):
    ...
    if(id_option == None ):
        print("El parametro id es obligatorio")
    elif(path_option==None):
        print("El parametro path es obligatorio")
    elif(name_option == None):
        print("El parametro name es obligatorio")
